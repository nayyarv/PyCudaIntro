...
\begin{frame}[t]\frametitle{CUDA Architecture}
  ...
  \begin{itemize}
    \item Each block runs 32 threads at a time (called warps) and shares a limited amount of memory available to all threads
    \item GTX 970 = 128 cores * 13 SMs = 52 concurrent warps
    \item Good idea to ensure blocks are multiple of 32 and that there are many more warps than hardware. 
    \item Most GPUs have more 32 bit processing power
...
\begin{frame}[t]\frametitle{PyCUDA}
  ...
  \begin{itemize}
    ...
    \item The mathematics needed to be done in Python for quick implementation and easy refinement.
    \item Allows for easier kernel writing since you can replace \#define's once you've seen the data (defining threads is easy)
...
\begin{columns}
  ...
  \column{0.5\textwidth}
    ...
    \begin{itemize}
      ...
      \item 50x improvement over sklearn
      \item Took 0.01 us per datapoint, or 0.01s for whole dataset
      \item $10^6$ evaluations would take ~2.5 hours!
    \end{itemize}
...
Code available \url{https://github.com/nayyarv/PyCudaIntro}
\begin{center}
Timing Data

\begin{tabular}{|c|c|c|c|}
\hline 
Eval & Simple & Sklearn & GPU\tabularnewline
\hline 
\hline 
10 & 0.35 & 0.02  & 0.12\tabularnewline
\hline 
100 & 3.45 & 0.05 & 0.02\tabularnewline
\hline 
1000 & 34.22 & 0.37 & 0.02\tabularnewline
\hline 
10000 & 344.93 & 4.6 & 0.13\tabularnewline
\hline 
100000 & 3474.57 & 53.39 & 1.07\tabularnewline
\hline 
\end{tabular}
\end{center}
